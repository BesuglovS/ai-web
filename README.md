...
Курс включает **50 уроков** в **9 разделах**, охватывающих историю AI, математические основы, нейронные сети, трансформеры, обучение моделей, большие языковые модели (LLM), открытые модели и локальный запуск, а также инструменты для разработчиков (Cline, Opencode, Hermes Agent).
